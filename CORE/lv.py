...
if __name__ == '__main__':
    ...
    # samples and gamma only matter for graph layout
    samples = -1
    gamma = -1
    Y = LargeVis.run(2, args.threads, samples, args.prop, args.alpha, args.trees, args.neg, args.neigh, args.gamma, args.perp)
